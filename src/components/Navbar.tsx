  ...
  return (
    <nav
      className="
        ...
        bg-black/90
        backdrop-blur-md
        border-b border-[#B244FF]/30
        shadow-[0_0_20px_rgba(178,68,255,0.25)]
        font-inter-tight
      "
    >
      <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
      ...
      {mobileOpen && (
        <div
          className="
            ...
            flex flex-col
            font-inter-tight
            border-l border-[#B244FF]/40
            shadow-[0_0_40px_rgba(178,68,255,0.35)]
          "
        >

          {/* HEADER */}
          <div className="flex justify-between items-center px-6 py-4 border-b border-[#B244FF]/30">
          ...
          {/* LINKS */}
          <div className="flex flex-col px-6 py-10 gap-7 text-lg">
            <Link href="/dashboard" onClick={() => setMobileOpen(false)} className="text-white">
              Dashboard
            </Link>
            <Link href="/leads" onClick={() => setMobileOpen(false)} className="text-white">
